    ...
    (function webpackUniversalModuleDefinition(root, factory) {
      ...
      return (() => {
        ...
        var __webpack_modules__ = {
          935: (__unused_webpack_module, exports2) => {
          ...
          function useLoading() {
            ...
            return {
              show() {
                ...
                const propsData = __spreadValues(__spreadValues(__spreadValues({}, globalProps), props), forceProps);
                let container = propsData.container;
                if (!propsData.container) {
                  container = document.body;
                  propsData.isFullPage = true;
                }
                const mergedSlots = __spreadValues(__spreadValues({}, globalSlots), slots);
...
var vue_loading_overlay_default = require_dist();
export {
